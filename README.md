...
**StarShinePlan** is a mod for Mindustry that is largely independent from the base game.

It focuses on **internal balance** and emphasizes **industry**, while **significantly increasing combat difficulty** (though early-game versions won't be too hard).

> **Note**: The mod contains an unfinished unit with custom stats and mechanics. This unit is **not** an enemy, **cannot** be built by the player, and is intended as a **reward unit for the final stage** — it is excluded from balance considerations.

---

### Current Progress

- **Power Rework**: Overhauls the power system by introducing the concept of **voltage levels**.
...
- This mod only supports **Mindustry v159.3 or later**.
- Compatibility with the base game and other mods has **not** been considered. If it crashes — don't blame me! 😄
...
>对了，mod里的那个单位（未完成）数值与机制不参与平衡，不会成为敌人，也无法制造，那是最终关卡的奖励单位。
